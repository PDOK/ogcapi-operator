...
import (
	...
	webhookpdoknlv1alpha1 "github.com/PDOK/ogcapi-operator/internal/webhook/v1alpha1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "cf777057.pdok.nl",
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookpdoknlv1alpha1.SetupOGCAPIWebhookWithManager(mgr); err != nil {
