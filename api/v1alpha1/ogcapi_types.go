...
type OGCAPIStatus struct {
	...
	// conditions represent the current state of the OGCAPI resource.
...
type OGCAPI struct {
	...
	// spec defines the desired state of OGCAPI
	// +required
	Spec OGCAPISpec `json:"spec"`

	// status defines the observed state of OGCAPI
	// +optional
	Status OGCAPIStatus `json:"status,omitzero"`
}
